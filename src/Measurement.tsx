...
export function DistanceMeasurement({ points, distance }: { points: [THREE.Vector3, THREE.Vector3], distance: number }) {
...
export function AngleMeasurement({ points, angle }: { points: [THREE.Vector3, THREE.Vector3, THREE.Vector3], angle: number }) {
